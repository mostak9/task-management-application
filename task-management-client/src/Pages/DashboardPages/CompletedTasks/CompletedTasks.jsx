...
const CompletedTasks = () => {
    ...
    if(completedLoading) return <div className="flex items-center justify-center min-h-screen"><Spinner /></div>
        ...
        <div>
         ...
         <div className='max-w-5xl mx-auto  m-auto shadow-2xl rounded-xl p-12'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-8'>
                {
                    completedList.map(data => <TaskCard key={data._id} data={data}/>)
                }
            </div>
        </div>
       </div>
